...
import (
	...
	"github.com/lanarthur/compress/s2"
)
...
const goEncoderShouldMatchCppEncoder = false

func TestMaxEncodedLenOfMaxBlockSize(t *testing.T) {
	maxEncodedLenOfMaxBlockSize := s2.MaxEncodedLen(maxBlockSize)
